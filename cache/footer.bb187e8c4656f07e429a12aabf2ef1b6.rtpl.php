...
<!-- jQuery sticky menu -->
<script src="/res/page/js/owl.carousel.min.js"></script>
<script src="/res/page/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/res/page/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/res/page/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/res/page/js/bxslider.min.js"></script>
<script type="text/javascript" src="/res/page/js/script.slider.js"></script>
</body>
</html>